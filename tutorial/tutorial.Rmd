...
The function *filterSharedTaxa* filters two morphological or molecular matrices to keep only shared taxa (rows) between them. This is useful when performing analyses with concatenated matrices or when comparing datasets with different taxon coverage. The function can output the filtered matrices either concatenated into a single file or as separate files, depending on the *output_concatenate* parameter.
...
```{r}
# Example 2: Separated output
filterSharedTaxa(input1 = mat1, 
                 input2 = mat2,
                 output_path="testdata/shared_taxa_sep",
